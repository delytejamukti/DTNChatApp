...
public class Select extends Activity implements PullToRefresh.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent in_select = getIntent();
        type_id = in_select.getStringExtra("type_id");
        if(type_id.equals("1")){
            lifetime = in_select.getStringExtra("lifetime");
        }else if(type_id.equals("2")){
            number_hop = in_select.getStringExtra("number_hop");
        }else{
            distance = in_select.getStringExtra("distance");
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(type_id.equals("1")){
                    ...
                    i.putExtra("number_hop",number_hop);
                }else{
